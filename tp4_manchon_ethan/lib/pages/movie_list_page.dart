                  ...
                  SnackBar(
                    ...
                    content: Row(
                      children: [
                        ...
                        Text('Le film ', style: const TextStyle(color: Colors.white),),
                        Text(movie.title, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold),),
                        Text(' a été ajouté aux favoris !', style: const TextStyle(color: Colors.white),),
                      ],
                    ),
                  ),
                )
                  ...
                  SnackBar(
                    ...
                    content: Row(
                      children: [
                        ...
                        const SizedBox(width: 12),
                        Text('Le film ', style: const TextStyle(color: Colors.black),),
                        Text(movie.title, style: const TextStyle(color: Colors.black, fontWeight: FontWeight.bold),),
                        Text(' a été retiré des favoris !', style: const TextStyle(color: Colors.black),),
                      ],
                    ),
                  ),
                )
